...
<script type="text/javascript">
	...
	jQuery("#list").jqGrid({
        ...
        {name:'studentNumber',index:'studentNumber',width:150,hidden:false,resizable:false,editable:true,sorttype:"string",editoptions:{size:15}},    //name表格列的名称,index排序时字段的索引,width只能是像素，不能是百分比
...
<div id="dialog" title="导入数据">
  ...
  <div id="result" style="color:red; font-size:18px;"></div>
	...
	<div class="table_container">
	   <div class="title"><h2>全日制学生列表</h2></div>
	   <table id="list"></table>
