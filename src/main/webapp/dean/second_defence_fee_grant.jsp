...
function upload(data){
	      $( "#dialog" ).dialog( "open" );
            ...
            var t = setInterval(function() {
             ...
             $("#result").html("正在导入...");
		$.ajaxFileUpload({
	         url:"./importSecondDefenceFeeGrantExcel.do",         
	         secureuri:false,
	         fileElementId:"file", 
	         dataType: "json", 
...
jQuery("#list").jqGrid({
		url:'getSecondDefenceFeesGrant.do?type=1',
     	datatype: 'json',    //从服务器端返回的数据类型，默认xml。可选类型：xml，local，json，jsonnp，script，xmlstring，jsonstring，clientside
     	mtype: 'POST',
     	colNames:['ID','学生姓名','学生学号','教师姓名','教师编号','费用金额','发放时间','发放方式'],		//表格的显示字段
		colModel:[  
        ...
        {name:'teacherName',index:'teacherName', width:100,editable:true,sorttype:"string",resizable:false},
        {name:'teacherNum',index:'teacherNum', width:100,editable:true,sorttype:"string",resizable:false},
		...
		width: 930,   
		rowNum: '9999',
		editurl: 'editSecondDefenceFeesGrant.do',
 ...
 //edit
	   ...
	   id : "export_excel", 
	   onClickButton: function(e){  
	   location.href="./exportSecondDefenceFeeGrantExcel.do";
	   },   
	   position:"last"
	}) ;
...
<div id="dialog" title="导入数据">
  ...
  <div id="result" style="color:red; font-size:18px;"></div>
	...
	<div class="table_container">
	   <div class="title"><h2>二次答辩费用发放列表</h2></div>
	   <table id="list"></table>
