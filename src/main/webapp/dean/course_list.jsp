...
jQuery("#list").jqGrid({
		url:'getallcourses.do?type=1',
     	datatype: 'json',    //从服务器端返回的数据类型，默认xml。可选类型：xml，local，json，jsonnp，script，xmlstring，jsonstring，clientside
     	mtype: 'POST',
     	colNames:['ID','课程编号','课程名称','教师编号','教师姓名','学年'],		//表格的显示字段
		colModel:[ 
        ...
        {name:'teacherNo',index:'teacherNo', width:150,editable:true,sorttype:"string",resizable:false}, 
        {name:'teacherName',index:'teacherName',width:100,sorttype:"string",resizable:false,editable:true},      
 ...
 //edit
	   ...
	   id : "export_excel", 
	   onClickButton: function(e){  
	   location.href="./exportCourseExcel.do";
	   },   
	   position:"last"
	}) ;
