...
<script type="text/javascript">
	...
	$("#list").jqGrid({
		...
		{name:'teacherClasses',index:'teacherClasses',width:100,editable:true,resizable:false,formatter:"select",edittype:'select',editoptions:{value:{1:'校内',2:'校外'}}},  
		{name:'teacherEducation',width:100,sortable:false,editable:true,resizable:false,formatter:"select",edittype:'select',editoptions: { value: {1:'本科',2:'硕士',3:'博士',4:'博士后'}}},
		{name:'teacherJobTitle',width:100,sortable:false,editable:true,resizable:false,formatter:"select",edittype:'select',editoptions: { value: {1:'讲师',2:'高级工程师',3:'副教授',4:'教授'}}},  
        {name:'teacherQualification',width:100,sortable:false,editable:true,resizable:false,formatter:"select",edittype:'select',editoptions: { value: {1:'工程硕士导师',2:'工学硕士导师',3:'博导'}}},  
