...
public class SuggestionController {
	 ...
	 * @param suggestionId
	 */
	@RequestMapping(value = "/suggestions/setSuggestionHasRead/{suggestionId}")
	@ResponseBody
	public void setSuggestionHasRead(HttpServletRequest request,
			HttpServletResponse response, @PathVariable Integer suggestionId) {
		logger.info("会话标记为已读，suggestion id: {}", suggestionId);
		JSONObject jsonobj = suggestionManager.setSuggestionHasRead(suggestionId);
		jsonUtil.sendJson(response, jsonobj);
	}
}
