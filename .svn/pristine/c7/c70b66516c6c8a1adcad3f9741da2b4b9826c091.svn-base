...
jQuery("#list").jqGrid({
 ...
 //edit
	   ...
	   id : "export_excel", 
	   onClickButton: function(e){  
	   location.href="./exportDefenceFeeExcel.do";
	   },   
	   position:"last"
	}) ;
...
<div id="dialog" title="导入数据">
  ...
  <div id="result" style="color:red; font-size:18px;"></div>
	...
	<div class="table_container">
	   <div class="title"><h2>答辩费发放列表</h2></div>
	   <table id="list"></table>
