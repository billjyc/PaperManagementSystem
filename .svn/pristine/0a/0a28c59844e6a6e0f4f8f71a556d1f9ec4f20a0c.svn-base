...
function upload(data){
	      $( "#dialog" ).dialog( "open" );
            ...
            var t = setInterval(function() {
             ...
             $("#result").html("正在导入...");
		$.ajaxFileUpload({
	         url:"./importTeachingPointExcel.do",         
	         secureuri:false,
	         fileElementId:"file", 
	         dataType: "json", 
...
jQuery("#list").jqGrid({
		url:'getallteachingpoint.do?type=1',
     	datatype: 'json',    //从服务器端返回的数据类型，默认xml。可选类型：xml，local，json，jsonnp，script，xmlstring，jsonstring，clientside
     	mtype: 'POST',
     	colNames:['ID','编号','名称','地点','负责人编号','负责人姓名'],		//表格的显示字段
		colModel:[  
        ...
        {name:'location',width:150, editable:true,viewable:true,editrules:{edithidden:true}},           
        {name:'directorNo',width:150,resizable:false,editable:true,sorttype:"string",editoptions:{size:15}},
        {name:'directorName', width:150,editable:true,sorttype:"string",resizable:false}
     	],    
 ...
 //edit
	   ...
	   id : "export_excel", 
	   onClickButton: function(e){  
	   location.href="./exportTeachingPointExcel.do";
	   },   
	   position:"last"
	}) ;
...
<div id="dialog" title="导入数据">
  ...
  <div id="result" style="color:red; font-size:18px;"></div>
	...
	<div class="table_container">
	   <div class="title"><h2>教学点列表</h2></div>
	   <table id="list"></table>
