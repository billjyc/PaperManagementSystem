...
function upload(data){
	      $( "#dialog" ).dialog( "open" );
            ...
            var t = setInterval(function() {
             ...
             $("#result").html("正在导入...");
		$.ajaxFileUpload({
	         url:"./importSecondJudgeFeeGrantExcel.do",         
	         secureuri:false,
	         fileElementId:"file", 
	         dataType: "json", 
...
jQuery("#list").jqGrid({
		url:'getSecondJudgeFeesGrant.do?type=1',
		...
		width: 930,   
		rowNum: '9999',
		editurl: 'editSecondJudgeFeesGrant.do',
 ...
 //edit
	   ...
	   id : "export_excel", 
	   onClickButton: function(e){  
	   location.href="./exportSecondJudgeFeeGrantExcel.do";
	   },   
	   position:"last"
	}) ;
...
<div id="dialog" title="导入数据">
  ...
  <div id="result" style="color:red; font-size:18px;"></div>
	...
	<div class="table_container">
	   <div class="title"><h2>二次评审费用发放列表</h2></div>
	   <table id="list"></table>
